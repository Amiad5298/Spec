"""Tests for ai_workflow.workflow.runner module."""

import pytest
from pathlib import Path
from unittest.mock import MagicMock, patch

from ai_workflow.workflow.runner import (
...
class TestShowCompletion:
    ...
    @patch("ai_workflow.workflow.runner.console")
    ...
    @patch("ai_workflow.workflow.runner.print_info")
    @patch("ai_workflow.workflow.runner.console")
...
class TestWorkflowCleanupUserCancelled:
    ...
    @patch("ai_workflow.workflow.runner._offer_cleanup")
    @patch("ai_workflow.workflow.runner.print_info")
    @patch("ai_workflow.workflow.runner.get_current_branch")
...
# =============================================================================
# Tests for workflow_cleanup() context manager - AIWorkflowError
# =============================================================================


class TestWorkflowCleanupAIWorkflowError:
    """Tests for workflow_cleanup handling AIWorkflowError."""

    @patch("ai_workflow.workflow.runner._offer_cleanup")
    @patch("ai_workflow.workflow.runner.print_error")
    @patch("ai_workflow.workflow.runner.get_current_branch")
    def test_catches_ai_workflow_error(
        self, mock_get_branch, mock_print_error, mock_offer_cleanup, workflow_state
    ):
        """Catches AIWorkflowError, prints error, calls _offer_cleanup, then re-raises."""
        mock_get_branch.return_value = "main"

        with pytest.raises(AIWorkflowError):
            with workflow_cleanup(workflow_state):
                raise AIWorkflowError("Workflow failed")
