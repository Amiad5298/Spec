...
class TestFundamentalTaskOrdering:
    ...
    def test_sorts_by_dependency_order_then_line_number(self):
        ...
        tasks = [
            Task(
                name="Task C", category=TaskCategory.FUNDAMENTAL, dependency_order=1, line_number=30
            ),
            Task(
                name="Task A", category=TaskCategory.FUNDAMENTAL, dependency_order=1, line_number=10
            ),
            Task(
                name="Task B", category=TaskCategory.FUNDAMENTAL, dependency_order=1, line_number=20
            ),
            Task(
                name="Task D", category=TaskCategory.FUNDAMENTAL, dependency_order=2, line_number=5
            ),
        ]
    ...
    def test_stable_ordering_with_same_values(self):
        ...
        tasks = [
            Task(
                name="First", category=TaskCategory.FUNDAMENTAL, dependency_order=0, line_number=0
            ),
            Task(
                name="Second", category=TaskCategory.FUNDAMENTAL, dependency_order=0, line_number=0
            ),
            Task(
                name="Third", category=TaskCategory.FUNDAMENTAL, dependency_order=0, line_number=0
            ),
        ]
    ...
    def test_explicit_order_comes_before_order_zero(self):
        ...
        tasks = [
            ...
            Task(
                name="Order2", category=TaskCategory.FUNDAMENTAL, dependency_order=2, line_number=20
            ),
            Task(
                name="NoOrder2",
                category=TaskCategory.FUNDAMENTAL,
            ...
            Task(
                name="Order1", category=TaskCategory.FUNDAMENTAL, dependency_order=1, line_number=40
            ),
        ]
...
class TestSecurityRegressions:
    ...
    def test_repo_root_is_required_not_optional(self, tmp_path):
        ...
        assert (
            repo_root_param.default is inspect.Parameter.empty
