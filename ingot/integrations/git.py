...
from ingot.utils.console import print_error, print_info, print_success, print_warning
from ingot.utils.logging import log_command
...
def handle_dirty_state(context: str, action: DirtyStateAction) -> bool:
    ...
    if action == DirtyStateAction.STASH:
        stash_msg = f"ingot: auto-stash before {context}"
